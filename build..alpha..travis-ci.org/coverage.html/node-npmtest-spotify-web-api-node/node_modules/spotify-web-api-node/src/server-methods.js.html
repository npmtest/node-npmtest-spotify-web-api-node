...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-spotify-web-api-node/node_modules/spotify-web-api-node/src/server-methods.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-spotify-web-api-node/node_modules/spotify-web-api-node/src/server-methods.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-spotify-web-api-node/node_modules/spotify-web-api-node/src/</a> &#187; server-methods.js</div>
</div>
<div class="body">
...
module.exports = {
   ...
   */
  clientCredentialsGrant: <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
...
&nbsp;
   ...
   */
  authorizationCodeGrant: <span class="fstat-no" title="function not covered" >function(code, callback) {</span>
<span class="cstat-no" title="statement not covered" >    var request = AuthenticationRequest.builder()</span>
      .withPath('/api/token')
      .withBodyParameters({
...
&nbsp;
   ...
   *          Not returned if a callback is given.
   */
  refreshAccessToken: <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >    var request = AuthenticationRequest.builder()</span>
      .withPath('/api/token')
      .withBodyParameters({
